...
from rental.serializers import PurchaseStudentSerializer, RentStudentSerializer
...
class StudentRentView(generics.ListAPIView):
    """
    List all rents of a student.
    """
    queryset = Student.objects.all()
    serializer_class = RentStudentSerializer

    def list(self, request, *args, **kwargs):
        queryset = self.get_object().rents
